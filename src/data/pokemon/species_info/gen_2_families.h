...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_CHIKORITA] =
    {
        ...
        .categoryName = _("Blatt"),
        .height = 9,
        .weight = 64,
        .description = COMPOUND_STRING(
        "Es wedelt mit seinem Blatt herum, um\n"
        "Feinde auf Distanz zu halten. Allerdings strömt auch\n"
        "ein süßer Duft aus dem Blatt, der eine\n"
        "freundliche Atmosphäre schafft, die die Kämpfer beruhigt."),
        .pokemonScale = 512,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BAYLEEF] =
    {
        ...
        .weight = 158,
        .description = COMPOUND_STRING(
        "Der Hals eines Lorbeerblattes ist von zusammengerollten\n"
        "Blättern umgeben. In jedem Blatt befindet sich ein\n"
        "kleiner Baumspross. Der Duft dieses Triebs\n"
        "macht die Menschen munter."),
        .pokemonScale = 296,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MEGANIUM] =
    {
        ...
        .categoryName = _("Kraut"),
        .height = 18,
        .weight = 1005,
        .description = COMPOUND_STRING(
        "Der Duft einer Meganium-Blume beruhigt und\n"
        "besänftigt die Gefühle. Im Kampf verströmt\n"
        "es mehr von seinem beruhigenden Duft, um\n"
    ...
    [SPECIES_CYNDAQUIL] =
    {
        ...
        .weight = 79,
        .description = COMPOUND_STRING(
        "Um sich selbst zu schützen, entfacht es Flammen\n"
        "aus seinem Rücken. Das Feuer brennt heftig,\n"
        "wenn das Pokémon wütend ist. Wenn es\n"
        "müde ist, stottert es und verbrennt unvollständig."),
        .pokemonScale = 539,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QUILAVA] =
    {
        ...
        .weight = 190,
        .description = COMPOUND_STRING(
        "Es schüchtert Feinde mit intensiven Flammenböen und überhitzter\n"
        "Luft ein. Dank seiner schnellen Beweglichkeit\n"
        "kann er Angriffen ausweichen, selbst wenn\n"
        "er einen Feind verbrennt."),
        .pokemonScale = 329,
        .pokemonOffset = 11,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TYPHLOSION] =
    {
        ...
        .weight = 795,
        .description = COMPOUND_STRING(
        "Es kann sich hinter einem schimmernden Hitzeschleier\n"
        "verstecken, den es mit seinen intensiven\n"
        "Flammen erzeugt. Typhlosion erzeugen lodernde\n"
        "Explosionen, die alles zu Asche verbrennen."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 268,
        .trainerOffset = 1,
    ...
    [SPECIES_TYPHLOSION_HISUI] =
    {
        ...
        .cryId = CRY_TYPHLOSION,
        .natDexNum = NATIONAL_DEX_TYPHLOSION,
        .categoryName = _("Geisterflamme"),
        .height = 16,
        .weight = 698,
        .description = COMPOUND_STRING(
        "Angeblich soll es verlorene, verlassene Seelen mit seinen\n"
        "Flammen reinigen und sie ins Jenseits führen. Es\n"
        "wird angenommen, dass seine Form in der Antike\n"
        "von der Energie des Mt. Coronet beeinflusst wurde."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 268,
        .trainerOffset = 1,
    ...
    [SPECIES_TOTODILE] =
    {
        ...
        .weight = 95,
        .description = COMPOUND_STRING(
        "Trotz seines kleinen Körpers sind die Kiefer von\n"
        "Totodile sehr kräftig. Auch wenn es denkt, dass\n"
        "es nur spielerisch knabbert, ist sein Biss stark\n"
        "genug, um ernsthafte Verletzungen zu verursachen."),
        .pokemonScale = 487,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CROCONAW] =
    {
        ...
        .weight = 250,
        .description = COMPOUND_STRING(
        "Sobald seine Kiefer seinen Gegner festhalten, lässt er\n"
        "ihn auf keinen Fall mehr los. Da die\n"
        "Spitzen seiner Reißzähne wie Angelhaken nach hinten\n"
        "gegabelt sind, bleiben sie unlösbar verankert."),
        .pokemonScale = 378,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FERALIGATR] =
    {
        ...
        "Feinde einzuschüchtern. Im Kampf rennt es mit seinen\n"
        "dicken und kräftigen Hinterbeinen und greift den\n"
        "Gegner mit unglaublicher Geschwindigkeit an."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 342,
        .trainerOffset = 7,
    ...
    [SPECIES_SENTRET] =
    {
        ...
        "sie abwechselnd Wache. Der Wachposten weckt die\n"
        "anderen, wenn er Gefahr wittert. Wenn jemand\n"
        "getrennt wird, wird er vor Angst schlaflos."),
        .pokemonScale = 439,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FURRET] =
    {
        ...
        .categoryName = _("Langer"),
        .height = 18,
        .weight = 325,
        .description = COMPOUND_STRING(
        "Ein Furret hat einen sehr schlanken Körperbau. Wenn\n"
        "es angegriffen wird, kann es sich durch\n"
        "enge Räume winden und entkommen. Trotz seiner kurzen\n"
        "Gliedmaßen ist er sehr flink und flink."),
        .pokemonScale = 346,
        .pokemonOffset = 11,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .weight = 212,
        .description = COMPOUND_STRING(
        "Es verfügt über ein inneres Organ,\n"
        "das die Erdrotation wahrnimmt. Mithilfe dieses speziellen\n"
        "Organs beginnt ein Hoothoot jeden Tag\n"
        "genau zur gleichen Zeit zu heulen."),
        .pokemonScale = 380,
        .pokemonOffset = -2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .weight = 408,
        .description = COMPOUND_STRING(
        "Es fängt stets Beute in der Dunkelheit.\n"
        "Noctowl verdanken ihren Erfolg ihrer überlegenen Sehkraft,\n"
        "die es ihnen ermöglicht, auch bei minimalem Licht\n"
        "zu sehen, und ihren geschmeidigen und lautlosen Flügeln."),
        .pokemonScale = 278,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .weight = 108,
        .description = COMPOUND_STRING(
        "Ledyba kommunizieren mit einer Flüssigkeit, die sie an\n"
        "der Stelle absondern, an der die Beine mit\n"
        "dem Körper verbunden sind. Sie sollen anderen Gefühle\n"
        "vermitteln, indem sie den Geruch der Flüssigkeit verändern."),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        "sauberer Luft, wo der Himmel mit Sternen gefüllt\n"
        "ist, viele Ledianer leben. Aus gutem Grund nutzen\n"
        "sie das Licht der Sterne als Energie."),
        .pokemonScale = 256,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .categoryName = _("String-Spucke"),
        .height = 5,
        .weight = 85,
        .description = COMPOUND_STRING(
        "Das Netz, das es spinnt, kann als sein\n"
        "zweites Nervensystem betrachtet werden. Es wird gesagt, dass\n"
        "ein Spinarak seine Beute anhand der winzigen Vibrationen\n"
        "erkennt, die er durch das Netz spürt."),
        .pokemonScale = 414,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .categoryName = _("Langes"),
        .height = 11,
        .weight = 335,
        .description = COMPOUND_STRING(
        "Seine Füße sind mit winzigen Hakenklauen versehen,\n"
        "die es ihm ermöglichen, an Decken und\n"
        "senkrechten Wänden entlangzuhuschen. Es umschnürt seinen Gegner\n"
        "mit dünnem und starkem Seidengewebe."),
        .pokemonScale = 316,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        "über seine beiden Antennen positive und negative Elektrizität\n"
        "ab. Es lebt in Tiefen außerhalb der\n"
        "Reichweite des Sonnenlichts."),
        .pokemonScale = 424,
        .pokemonOffset = -2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_LANTURN] =
    {
        ...
        .categoryName = _("Licht"),
        .height = 12,
        .weight = 225,
        .description = COMPOUND_STRING(
        "Die leuchtenden Kugeln auf seinem Rücken\n"
        "sind sehr hell. Sie bestehen aus einem\n"
        "Teil seiner Rückenflosse. Dieses Pokémon erhellt\n"
        "die tintenschwarze Dunkelheit der Tiefsee."),
        .pokemonScale = 269,
        .pokemonOffset = 6,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        "Mitgefühls und der Freude, die Menschen\n"
        "und Pokémon ausstrahlen. Es speichert glückliche Gefühle\n"
        "in seiner Hülle und gibt sie dann weiter."),
        .pokemonScale = 507,
        .pokemonOffset = 23,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TOGETIC] =
    {
        ...
        "bringt. Wenn es jemanden entdeckt, der reinen\n"
        "Herzens ist, erscheint ein Togetic und teilt\n"
        "sein Glück mit dieser Person."),
        .pokemonScale = 424,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TOGEKISS] =
    {
        ...
        .categoryName = _("Jubiläum"),
        .height = 15,
        .weight = 380,
        .description = COMPOUND_STRING(
        "Wie jeder weiß, besucht es friedliche Regionen\n"
        "und bringt ihnen Geschenke der Güte und\n"
        "süßen Segen. Es wird niemals dort erscheinen,\n"
        "wo es Streit gibt."),
        .pokemonScale = 268,
        .pokemonOffset = 2,
        .trainerScale = 271,
    ...
    [SPECIES_NATU] =
    {
        ...
        "Savanne wachsen, um neue Triebe zu picken.\n"
        "Die Augen eines Natus sehen so aus,\n"
        "als würden sie ständig etwas beobachten."),
        .pokemonScale = 610,
        .pokemonOffset = 25,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_XATU] =
    {
        ...
        .weight = 150,
        .description = COMPOUND_STRING(
        "Es hat die rätselhafte Kraft, die Zukunft\n"
        "vorherzusehen. Einige Menschen in verschiedenen Ländern glauben\n"
        "seit langem, dass Xatu Abgesandte\n"
        "aus einer anderen Welt seien."),
        .pokemonScale = 256,
        .pokemonOffset = 6,
        .trainerScale = 318,
        .trainerOffset = 4,
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .weight = 78,
        .description = COMPOUND_STRING(
        "Seine flauschige Wolle reibt aneinander und lädt\n"
        "sich statisch auf. Je mehr Energie\n"
        "geladen ist, desto heller leuchtet die Glühbirne\n"
        "an der Spitze seines Schwanzes."),
        .pokemonScale = 379,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FLAAFFY] =
    {
        ...
        "mit einer kleinen Wollmenge starke statische\n"
        "Elektrizität zu erzeugen. Die blanken, glatten Teile\n"
        "seiner Haut sind gegen Elektrizität abgeschirmt."),
        .pokemonScale = 372,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        "sogar vom Weltraum aus gesehen werden kann.\n"
        "Früher nutzten die Menschen sein Licht, um Signale\n"
        "an weit entfernte Menschen zu senden."),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AMPHAROS_MEGA] =
    {
        ...
        "erweckten offenbar das lange schlafende\n"
        "Drachenblut."),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
    ...
    [SPECIES_AZURILL] =
    {
        ...
        .categoryName = _("Tupfen"),
        .height = 2,
        .weight = 20,
        .description = COMPOUND_STRING(
        "Sein mit Nährstoffen gefüllter Schwanz ist sehr\n"
        "federnd wie ein Gummiball. An sonnigen Tagen\n"
        "versammeln sie sich am Wasserrand und\n"
        "planschen aus Spaß."),
        .pokemonScale = 603,
        .pokemonOffset = 23,
        .trainerScale = 256,
    ...
    [SPECIES_MARILL] =
    {
        ...
        .categoryName = _("Aqua-Maus"),
        .height = 4,
        .weight = 85,
        .description = COMPOUND_STRING(
        "Sein Körper ist mit wasserabweisendem Fell\n"
        "bedeckt. Aufgrund des Fells kann es\n"
        "mit hoher Geschwindigkeit durch Wasser schwimmen, ohne\n"
        "durch den Wasserwiderstand gebremst zu werden."),
        .pokemonScale = 476,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AZUMARILL] =
    {
        ...
        .categoryName = _("Aqua-Kaninchen"),
        .height = 8,
        .weight = 285,
        .description = COMPOUND_STRING(
        "Es lebt praktisch den ganzen Tag im Wasser.\n"
        "Seine Körperfarbe und sein Muster dienen\n"
        "als Tarnung und machen es für Feinde\n"
        "im Wasser schwer zu erkennen."),
        .pokemonScale = 448,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BONSLY] =
    {
        ...
        .weight = 150,
        .description = COMPOUND_STRING(
        "Bonsly bevorzugt eine trockene Atmosphäre. Um den\n"
        "Flüssigkeitsspiegel in seinem Körper zu regulieren, scheidet\n"
        "es Wasser aus seinen Augen aus. Dadurch sieht\n"
        "es so aus, als würde es weinen."),
        .pokemonScale = 432,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SUDOWOODO] =
    {
        ...
        .categoryName = _("Nachahmung"),
        .height = 12,
        .weight = 380,
        .description = COMPOUND_STRING(
        "Es ahmt einen Baum nach, um Angriffen\n"
        "durch Feinde zu entgehen. Da seine Vorderbeine\n"
        "aber das ganze Jahr über grün bleiben, ist\n"
        "er im Winter leicht als Fälschung zu erkennen."),
        .pokemonScale = 305,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HOPPIP] =
    {
        ...
        .categoryName = _("Baumwollkraut"),
        .height = 4,
        .weight = 5,
        .description = COMPOUND_STRING(
        "Dieses Pokémon treibt und schwebt mit dem\n"
        "Wind. Wenn ein Hoppip die Annäherung starker Winde\n"
        "spürt, verbindet er seine Blätter mit anderen,\n"
        "um sich gegen das Wegblasen zu wappnen."),
        .pokemonScale = 562,
        .pokemonOffset = -7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SKIPLOOM] =
    {
        ...
        "wird sie manchmal als Thermometer verwendet."),
        .pokemonScale = 387,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_JUMPLUFF] =
    {
        ...
        .weight = 30,
        .description = COMPOUND_STRING(
        "Jumpluff reiten auf warmen Südwinden, überqueren\n"
        "das Meer und fliegen in fremde Länder.\n"
        "Dieses Pokémon landet, wenn es beim\n"
        "Schweben auf kalte Luft trifft."),
        .pokemonScale = 418,
        .pokemonOffset = -4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AIPOM] =
    {
        ...
        .weight = 115,
        .description = COMPOUND_STRING(
        "Sein Schwanz endet mit einem geschickten,\n"
        "handlichen Fortsatz. Allerdings sind Aipoms echte Hände\n"
        "ziemlich ungeschickt geworden, weil es den\n"
        "Schwanz so oft nutzt."),
        .pokemonScale = 363,
        .pokemonOffset = 6,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AMBIPOM] =
    {
        ...
        .weight = 203,
        .description = COMPOUND_STRING(
        "Sie leben auf großen Bäumen. Die in zwei Teile\n"
        "geteilten Schwänze sind so geschickt darin, Dinge zu handhaben\n"
        "und zu erledigen, dass Ambipom seine Hände nur\n"
        "noch selten benutzt."),
        .pokemonScale = 282,
        .pokemonOffset = 3,
        .trainerScale = 256,
    ...
    [SPECIES_SUNKERN] =
    {
        ...
        .weight = 18,
        .description = COMPOUND_STRING(
        "Sunkern versuchen, die Bewegung zu minimieren,\n"
        "um die Nährstoffe zu erhalten, die sie in\n"
        "ihrem Körper für die Evolution gespeichert haben. Sie\n"
        "fressen nicht und ernähren sich nur vom Morgentau."),
        .pokemonScale = 541,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SUNFLORA] =
    {
        ...
        .weight = 85,
        .description = COMPOUND_STRING(
        "Sunflora wandelt Sonnenenergie in Nahrung um.\n"
        "Am warmen Tag sind sie sehr aktiv,\n"
        "hören aber plötzlich auf, sich zu bewegen,\n"
    ...
    [SPECIES_YANMA] =
    {
        ...
        .categoryName = _("Klarer"),
        .height = 12,
        .weight = 380,
        .description = COMPOUND_STRING(
        "Es kann 360 Grad sehen, ohne seine Augen\n"
        "zu bewegen. Es ist ein großartiger Flieger, der in der\n"
        "Lage ist, plötzliche Stopps einzulegen und sich in der Luft\n"
        "zu drehen, um gezielte Beute schnell zu jagen."),
        .pokemonScale = 274,
        .pokemonOffset = -1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_YANMEGA] =
    {
        ...
        .weight = 515,
        .description = COMPOUND_STRING(
        "Dieses sechsbeinige Pokémon ist problemlos in der Lage,\n"
        "einen Erwachsenen im Flug zu transportieren. Es ist\n"
        "geschickt darin, Feinde auseinanderzubeißen, während es mit\n"
        "hoher Geschwindigkeit vorbeifliegt."),
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 326,
        .trainerOffset = 4,
    ...
    [SPECIES_WOOPER] =
    {
        ...
        .categoryName = _("Wasserfisch"),
        .height = 4,
        .weight = 85,
        .description = COMPOUND_STRING(
        "Wooper leben normalerweise im Wasser, kommen aber\n"
        "gelegentlich auf der Suche nach Nahrung an Land.\n"
        "An Land überziehen sie ihren Körper mit\n"
        "einem klebrigen, giftigen Film."),
        .pokemonScale = 479,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QUAGSIRE] =
    {
        ...
        .weight = 750,
        .description = COMPOUND_STRING(
        "Ein Quagsire jagt, indem er sein Maul im\n"
        "Wasser weit geöffnet lässt und darauf wartet, dass\n"
        "seine Beute hineinstolpert. Da er sich nicht bewegt,\n"
        "wird er nicht sehr hungrig."),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WOOPER_PALDEA] =
    {
        ...
        .weight = 110,
        .description = COMPOUND_STRING(
        "Nachdem er einen Territorialkampf verloren hatte, begann\n"
        "Wooper, an Land zu leben. Das\n"
        "Pokémon veränderte sich im Laufe der Zeit und entwickelte\n"
        "einen giftigen Film, um seinen Körper zu schützen."),
        .pokemonScale = 479,
        .pokemonOffset = 21,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CLODSIRE] =
    {
        ...
        .categoryName = _("Stacheliger"),
        .height = 18,
        .weight = 2230,
        .description = COMPOUND_STRING(
        "Wenn dieses Pokémon angegriffen wird, revanchiert es\n"
        "sich, indem es dicke Stacheln aus seinem\n"
        "Körper streckt. Es ist ein riskanter\n"
        "Schritt, der alles aufs Spiel setzt."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MURKROW] =
    {
        ...
        .weight = 21,
        .description = COMPOUND_STRING(
        "Murkrow wurden als angebliche Unglücksbringer\n"
        "gefürchtet. Es zeigt großes Interesse an\n"
        "allem, was glänzt. Es wird sogar\n"
        "versucht, Frauen Ringe zu stehlen."),
        .pokemonScale = 401,
        .pokemonOffset = -8,
        .trainerScale = 256,
        .trainerOffset = 1,
    ...
    [SPECIES_HONCHKROW] =
    {
        ...
        .weight = 273,
        .description = COMPOUND_STRING(
        "Es ist bekannt, dass es nachts\n"
        "aktiv wird und zahlreiche Murkrow im Schlepptau\n"
        "hat. Es heißt, dass es die Fehler\n"
        "seiner Kumpane niemals verzeiht."),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .categoryName = _("Kreischen"),
        .height = 7,
        .weight = 10,
        .description = COMPOUND_STRING(
        "Ein Misdreavus erschreckt Menschen mit einem\n"
        "unheimlichen, schluchzenden Schrei. Offenbar nutzt es seine\n"
        "roten Kugeln, um die Angst vor Feinden als\n"
    ...
    [SPECIES_MISMAGIUS] =
    {
        ...
        .weight = 44,
        .description = COMPOUND_STRING(
        "Seine Schreie klingen wie Beschwörungen. Wer\n"
        "es hört, wird von Kopfschmerzen und\n"
        "Halluzinationen geplagt. Es erscheint dort,\n"
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_WYNAUT] =
    {
        ...
        .weight = 140,
        .description = COMPOUND_STRING(
        "Ein Wynaut isst gerne süße\n"
        "Früchte. Mit seinen ohrenähnlichen Armen pflückt er\n"
        "geschickt Früchte. Sie versammeln sich in Obstgärten,\n"
        "angezogen vom Duft."),
        .pokemonScale = 484,
        .pokemonOffset = 19,
        .trainerScale = 256,
    ...
    [SPECIES_WOBBUFFET] =
    {
        ...
        .categoryName = _("Geduldig"),
        .height = 13,
        .weight = 285,
        .description = COMPOUND_STRING(
        "Ein Wobbuffet ist normalerweise fügsam und schlägt heftig\n"
        "zurück, wenn sein schwarzer Schwanz angegriffen wird. Es baut\n"
        "sein Versteck in Höhlen, wo es auf den Einbruch\n"
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        "er frisst Gras und Baumsprossen. Während es\n"
        "frisst, macht sein Schwanz Kau- und\n"
        "Schluckbewegungen, als würde es auch fressen."),
        .pokemonScale = 281,
        .pokemonOffset = 1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FARIGIRAF] =
    {
        ...
        .weight = 1600,
        .description = COMPOUND_STRING(
        "Da nun die Gehirnwellen von Kopf\n"
        "und Schwanz synchronisiert sind, ist\n"
        "die psychische Kraft dieses Pokémon zehnmal\n"
        "stärker als die von Girafarig."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PINECO] =
    {
        ...
        .categoryName = _("Sackwurm"),
        .height = 6,
        .weight = 72,
        .description = COMPOUND_STRING(
        "Ein Pineco hängt an einem Ast\n"
        "und wartet auf Beute. Wenn es beim\n"
        "Essen dadurch gestört wird, dass jemand seinen Baum\n"
        "schüttelt, fällt es zu Boden und explodiert plötzlich."),
        .pokemonScale = 445,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FORRETRESS] =
    {
        ...
        "Beim Beutefang öffnet sich das Gehäuse, allerdings\n"
        "so schnell, dass man das Innere des\n"
        "Gehäuses nicht sehen kann."),
        .pokemonScale = 293,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .categoryName = _("Landschlange"),
        .height = 15,
        .weight = 140,
        .description = COMPOUND_STRING(
        "Mit seinem bohrspitzenförmigen Schwanz gräbt er sich rückwärts\n"
        "in den Boden. Es ist bekannt, dass\n"
        "dieses Pokémon seine Nester in komplexen Formen tief\n"
        "unter der Erde baut."),
        .pokemonScale = 316,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_DUDUNSPARCE_TWO_SEGMENT] =
    {
        ...
        .weight = 392,
        .description = COMPOUND_STRING(
        "Dieses Pokémon nutzt seinen harten Schwanz, um sein\n"
        "Nest zu bauen, indem es Löcher in das\n"
        "Grundgestein tief unter der Erde bohrt. Das Nest\n"
        "kann eine Länge von über sechs Meilen erreichen."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DUDUNSPARCE_THREE_SEGMENT] =
    {
        ...
        "Anzahl der Segmente, die der Körper eines\n"
        "Dudunsparce hat, durch die Gene des\n"
        "Pokémon bestimmt wird."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .categoryName = _("Fliegen"),
        .height = 11,
        .weight = 648,
        .description = COMPOUND_STRING(
        "Es gleitet, ohne ein einziges Geräusch zu machen.\n"
        "Mit seinen Hinter- und großen Vorderklauen ergreift es\n"
        "das Gesicht seines Gegners und sticht dann\n"
        "mit seinem Giftstachel zu."),
        .pokemonScale = 350,
        .pokemonOffset = -1,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GLISCOR] =
    {
        ...
        .weight = 425,
        .description = COMPOUND_STRING(
        "Gliscor beobachtet Beute, während er\n"
    ...
    [SPECIES_SNUBBULL] =
    {
        ...
        .weight = 78,
        .description = COMPOUND_STRING(
        "Indem es seine Reißzähne entblößt und ein gruseliges\n"
        "Gesicht macht, schickt es kleinere Pokémon in Angst und Schrecken\n"
        "davon. Der Snubbull scheint ein wenig traurig darüber zu\n"
        "sein, dass er seine Feinde in die Flucht treibt."),
        .pokemonScale = 465,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GRANBULL] =
    {
        ...
        .weight = 487,
        .description = COMPOUND_STRING(
        "Es hat einen besonders gut entwickelten Unterkiefer. Die riesigen\n"
        "Reißzähne sind schwer und verursachen eine Neigung\n"
        "des Kopfes. Sofern es nicht erschreckt wird, wird\n"
        "es nicht versuchen zu beißen."),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .weight = 39,
        .description = COMPOUND_STRING(
        "Ein Qwilfish nutzt den Druck des Wassers,\n"
        "das er schluckt, um giftige Stacheln auf\n"
        "einmal aus seinem ganzen Körper abzuschießen.\n"
        "Schwimmen empfindet er als etwas herausfordernd."),
        .pokemonScale = 430,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QWILFISH_HISUI] =
    {
        ...
        .weight = 39,
        .description = COMPOUND_STRING(
        "Eine Form von Qwilfish aus der fernen\n"
        "Vergangenheit. Fischer verabscheuen dieses lästige Pokémon, weil\n"
        "es Gift aus seinen Stacheln versprüht und\n"
        "es so überallhin mitnimmt."),
        .pokemonScale = 430,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_OVERQWIL] =
    {
        ...
        "Es schlürft Gift, um sich zu ernähren."),
        .pokemonScale = 257,
        .pokemonOffset = 10,
        .trainerScale = 423,
        .trainerOffset = 8,
    ...
    [SPECIES_SHUCKLE] =
    {
        ...
        .weight = 205,
        .description = COMPOUND_STRING(
        "Ein Shuckle versteckt sich unter Steinen und hält\n"
        "seinen Körper in seinem Panzer verborgen, während\n"
        "er gelagerte Beeren frisst. Die Beeren vermischen sich\n"
        "mit den Körperflüssigkeiten und bilden einen Saft."),
        .pokemonScale = 485,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HERACROSS] =
    {
        ...
        .categoryName = _("Einzelnes"),
        .height = 15,
        .weight = 540,
        .description = COMPOUND_STRING(
        "Sie versammeln sich in Wäldern auf der Suche nach\n"
        "dem süßen Saft der Bäume. Es ist komplett mit\n"
        "einer stahlharten Schale ummantelt. Es ist stolz auf sein\n"
        "Horn, mit dem es Feinde schleudert."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HERACROSS_MEGA] =
    {
        ...
        .weight = 625,
        .description = COMPOUND_STRING(
        "Ein enormer Energiezufluss baut ihn auf, aber\n"
        "als Mega Evolution endet, wird\n"
        "Heracross von einem schrecklichen Muskelkater\n"
        "geplagt."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .categoryName = _("Scharfe"),
        .height = 9,
        .weight = 280,
        .description = COMPOUND_STRING(
        "Ein Sneasel erklimmt Bäume, indem er seine\n"
        "Hakenkrallen in die Rinde schlägt. Es sucht unbewachte\n"
        "Nester auf und stiehlt Eier als Nahrung, wenn\n"
        "die Eltern nicht da sind."),
        .pokemonScale = 413,
        .pokemonOffset = -3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        "fünf Personen und hinterlassen einander Zeichen auf\n"
        "Bäumen und Felsen. Mit koordinierten Angriffen\n"
        "erlegen sie ihre Beute."),
        .pokemonScale = 320,
        .pokemonOffset = 7,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SNEASEL_HISUI] =
    {
        ...
        .weight = 270,
        .description = COMPOUND_STRING(
        "Seine robusten, gebogenen Krallen eignen sich\n"
        "ideal zum Überqueren steiler Klippen. Von den\n"
        "Spitzen dieser Krallen tropft ein Gift, das\n"
        "in die Nerven jeder gefangenen Beute eindringt."),
        .pokemonScale = 413,
        .pokemonOffset = -3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SNEASLER] =
    {
        ...
        .categoryName = _("Freier"),
        .height = 13,
        .weight = 430,
        .description = COMPOUND_STRING(
        "Aufgrund seines bösartigen Giftes und seiner beeindruckenden\n"
        "körperlichen Stärke konnte keine andere Art hoffen,\n"
        "es im gefrorenen Hochland zu übertreffen. Er\n"
        "bevorzugt die Einsamkeit und bildet keine Rudel."),
        .pokemonScale = 272,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TEDDIURSA] =
    {
        ...
        .weight = 88,
        .description = COMPOUND_STRING(
        "Es leckt seine Handflächen, die durch das Einweichen\n"
        "in Honig gesüßt werden. Ein Teddiursa stellt seinen\n"
        "eigenen Honig her, indem er von Beedrill gesammelte\n"
        "Früchte und Pollen mischt."),
        .pokemonScale = 455,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_URSARING] =
    {
        ...
        .categoryName = _("Winterschlaf"),
        .height = 18,
        .weight = 1258,
        .description = COMPOUND_STRING(
        "Man sagt, dass es in Wäldern viele Bäche\n"
        "und hoch aufragende Bäume gibt, in denen\n"
        "ein Ursaring Nahrung sammelt. Es wandert jeden\n"
        "Tag durch seinen Wald und sammelt Nahrung."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_URSALUNA] =
    {
        ...
        .weight = 2900,
        .description = COMPOUND_STRING(
        "Sumpfiges Gelände verleiht Ursaluna seinen kräftigen Körperbau\n"
        "und die neu entdeckte Fähigkeit, Torf\n"
    ...
    [SPECIES_URSALUNA_BLOODMOON] =
    {
        ...
        "einem neuen Land an Land. Das Überleben an\n"
        "diesem Ort führte dazu, dass es ein\n"
        "einzigartiges Aussehen annahm und besondere Kräfte erlangte."),
        .pokemonScale = 256,
        .pokemonOffset = 3,
        .trainerScale = 369,
        .trainerOffset = 7,
    ...
    [SPECIES_SLUGMA] =
    {
        ...
        .weight = 350,
        .description = COMPOUND_STRING(
        "Es handelt sich um eine Pokémon-Art, die in vulkanischen\n"
        "Gebieten lebt. Wenn sein Körper abkühlt, verhärtet sich seine Haut\n"
        "und macht ihn bewegungsunfähig. Um das zu vermeiden, schläft es\n"
        "in der Nähe von Magma."),
        .pokemonScale = 329,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MAGCARGO] =
    {
        ...
        .weight = 550,
        .description = COMPOUND_STRING(
        "Die Schale auf seiner Rückseite besteht\n"
        "aus gehärtetem Magma. Zehntausende Jahre, die\n"
        "sie in Vulkankratern verbracht haben, haben\n"
        "Magcargos Körper in Magma verwandelt."),
        .pokemonScale = 332,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SWINUB] =
    {
        ...
        "Schnauze am Boden reibt. Sein Lieblingsessen ist\n"
        "ein Pilz, der unter getrocknetem Gras\n"
        "wächst. Es verwurzelt gelegentlich heiße Quellen."),
        .pokemonScale = 324,
        .pokemonOffset = 20,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PILOSWINE] =
    {
        ...
        .weight = 558,
        .description = COMPOUND_STRING(
        "Ein Piloswine ist mit einer dicken, langen\n"
        "Haarschicht bedeckt, um der eisigen Kälte standzuhalten. Mit\n"
        "seinen Stoßzähnen gräbt er Nahrung aus, die unter\n"
        "dem Eis vergraben ist."),
        .pokemonScale = 306,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MAMOSWINE] =
    {
        ...
        .categoryName = _("Zwillingsstoßzahn"),
        .height = 25,
        .weight = 2910,
        .description = COMPOUND_STRING(
        "Ein gefrorener Mamoswine wurde aus 10.000\n"
        "Jahre altem Eis gegraben. Es erwachte zu\n"
        "großem Erstaunen. Dieses Pokémon gibt es\n"
        "schon seit langer, langer, langer Zeit."),
        .pokemonScale = 257,
        .pokemonOffset = 6,
        .trainerScale = 423,
        .trainerOffset = 8,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_CORSOLA] =
    {
        ...
        .weight = 50,
        .description = COMPOUND_STRING(
        "Corsola leben in warmen südlichen Meeren.\n"
        "Wenn das Meer verschmutzt wird, verfärben\n"
        "sich die wunderschönen Korallenstiele und zerfallen\n"
        "in Fetzen."),
        .pokemonScale = 410,
        .pokemonOffset = 15,
        .trainerScale = 256,
    ...
    [SPECIES_CORSOLA_GALAR] =
    {
        ...
        .weight = 5,
        .description = COMPOUND_STRING(
        "Der plötzliche Klimawandel hat diese alte\n"
        "Art von Corsola ausgelöscht. Mit seinen Ästen nimmt\n"
        "es die Lebenskraft anderer auf. Es verflucht\n"
        "diejenigen, die es ahnungslos aus Versehen treten."),
        .pokemonScale = 410,
        .pokemonOffset = 15,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CURSOLA] =
    {
        ...
        .weight = 4,
        .description = COMPOUND_STRING(
        "Seine Hülle strömt über vor\n"
        "erhöhter jenseitiger Energie. Das Ektoplasma\n"
        "dient als Schutz für den\n"
        "Kerngeist dieses Pokémon."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_REMORAID] =
    {
        ...
        "um verschlucktes Wasser kraftvoll auszustoßen und\n"
        "dann fliegende Beute abzuschießen. Wenn die\n"
        "Evolution naht, wandert sie flussabwärts."),
        .pokemonScale = 316,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .weight = 285,
        .description = COMPOUND_STRING(
        "Es umfängt seinen Feind mit seinen Saugnäpfen,\n"
        "bevor es den letzten Schlag ausführt. Wenn\n"
        "sich herausstellt, dass der Feind zu stark ist,\n"
        "spuckt er Tinte aus, um zu entkommen."),
        .pokemonScale = 296,
        .pokemonOffset = 3,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DELIBIRD] =
    {
        ...
        .categoryName = _("Lieferung"),
        .height = 9,
        .weight = 160,
        .description = COMPOUND_STRING(
        "Es trägt gebündelte Nahrung in seinem Schwanz. Es gab\n"
        "einen berühmten Entdecker, dem es gelang,\n"
        "den Mount Everest zu besteigen, weil ein\n"
        "Delibird sein Futter mit ihm teilte."),
        .pokemonScale = 293,
        .pokemonOffset = 11,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MANTYKE] =
    {
        ...
        "Schiffen das Muster auf seinem Rücken beobachten.\n"
        "Es schwimmt oft in einem Schwarm Remoraiden."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
        .trainerOffset = 0,
    ...
    [SPECIES_MANTINE] =
    {
        ...
        .weight = 2200,
        .description = COMPOUND_STRING(
        "An sonnigen Tagen kann man Mantine-Schwärme dabei\n"
        "beobachten, wie sie elegant über die Wellen\n"
        "springen. Der Remoraid, der die Fahrten mitnimmt,\n"
        "stört ihn nicht."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 342,
    ...
    [SPECIES_SKARMORY] =
    {
        ...
        .categoryName = _("Rüstungsvogel"),
        .height = 17,
        .weight = 505,
        .description = COMPOUND_STRING(
        "Ein Pokémon mit einem Körper und Flügeln aus\n"
        "Stahl. Früher verwendeten die Menschen aus Skarmory\n"
        "gefallene Federn zur Herstellung von Schwertern und\n"
        "Messern."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 271,
    ...
    [SPECIES_HOUNDOUR] =
    {
        ...
        .categoryName = _("Dunkel"),
        .height = 6,
        .weight = 108,
        .description = COMPOUND_STRING(
        "Jagdhunde kommunizieren untereinander mit verschiedenen Schreien,\n"
        "um ihre Beute in die Enge\n"
        "zu treiben. Die bemerkenswerte Teamarbeit dieses\n"
        "Pokémon ist einfach beispiellos."),
        .pokemonScale = 393,
        .pokemonOffset = 16,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HOUNDOOM] =
    {
        ...
        .weight = 350,
        .description = COMPOUND_STRING(
        "In einem Houndoom-Rudel übernimmt derjenige mit\n"
        "den scharf nach hinten geneigten Hörnern\n"
        "eine Führungsrolle. Sie wählen ihren Anführer, indem\n"
        "sie untereinander kämpfen."),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_HOUNDOOM_MEGA] =
    {
        ...
        .weight = 495,
        .description = COMPOUND_STRING(
        "Seine roten Krallen und die Schwanzspitzen\n"
        "schmelzen aufgrund der hohen Innentemperaturen, die\n"
        "für Houndoom selbst schmerzhaft sind.\n"),
        .pokemonScale = 256,
        .pokemonOffset = 4,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .categoryName = _("Lange"),
        .height = 5,
        .weight = 335,
        .description = COMPOUND_STRING(
        "Phanpys große Ohren dienen als breite Fächer. Wenn\n"
        "es heiß wird, wedelt es eifrig mit den\n"
        "Ohren, um sich abzukühlen. Auch die Jungen sind\n"
        "sehr stark."),
        .pokemonScale = 465,
        .pokemonOffset = 21,
        .trainerScale = 256,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .weight = 1200,
        .description = COMPOUND_STRING(
        "Ein Donphan ist so stark, dass\n"
        "er problemlos einen Muldenkipper ziehen kann. Seine\n"
        "Haut ist steinhart geworden. Ein gewöhnlicher\n"
        "Angriff hinterlässt nicht einmal einen Kratzer."),
        .pokemonScale = 313,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_STANTLER] =
    {
        ...
        .categoryName = _("Großes"),
        .height = 14,
        .weight = 712,
        .description = COMPOUND_STRING(
        "Stantlers prachtvolle Geweihe wurden einst zu\n"
        "hohen Preisen als Kunstwerke gehandelt. Infolgedessen\n"
        "wurde dieses Pokémon kurz vor\n"
        "der Ausrottung gejagt."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WYRDEER] =
    {
        ...
        "unheimlichen Licht, wenn sie unsichtbare Barrieren errichten.\n"
        "Das vom Bart abgeworfene Fell speichert die\n"
        "Wärme und ist nützlich für Winterkleidung."),
        .pokemonScale = 267,
        .pokemonOffset = 2,
        .trainerScale = 286,
        .trainerOffset = 1,
    ...
    [SPECIES_SMEARGLE] =
    {
        ...
        .weight = 580,
        .description = COMPOUND_STRING(
        "Ein Smeargle markiert sein Revier mit\n"
        "einer Flüssigkeit, die aus der Spitze\n"
        "seines Schwanzes austritt. Es wurden etwa 5.000\n"
        "verschiedene Spuren dieses Pokémon gefunden."),
        .pokemonScale = 287,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MILTANK] =
    {
        ...
        .weight = 755,
        .description = COMPOUND_STRING(
        "Es gibt täglich über fünf Gallonen Milch. Seine\n"
        "süße Milch wird von Kindern und Erwachsenen\n"
        "gleichermaßen genossen. Menschen, die keine Milch trinken\n"
        "können, verarbeiten daraus Joghurt und essen ihn stattdessen."),
        .pokemonScale = 280,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_RAIKOU] =
    {
        ...
        .weight = 1780,
        .description = COMPOUND_STRING(
        "Raikou verkörpert die Geschwindigkeit des Blitzes.\n"
        "Sein Brüllen schickt Schockwellen durch\n"
        "die Luft und den\n"
    ...
    [SPECIES_ENTEI] =
    {
        ...
        .weight = 1980,
        .description = COMPOUND_STRING(
        "Entei verkörpert die Leidenschaft von Magma.\n"
        "Es wird angenommen, dass es bei einem\n"
        "Vulkanausbruch entstanden ist. Es sprengt Feuer, das\n"
        "alles verzehrt, was es berührt."),
        .pokemonScale = 259,
        .pokemonOffset = 0,
        .trainerScale = 345,
        .trainerOffset = 7,
    ...
    [SPECIES_SUICUNE] =
    {
        ...
        "reinen Wasserquelle. Mit gleitender Eleganz läuft\n"
        "es über das Land. Es hat die\n"
        "Kraft, schmutziges Wasser zu reinigen."),
        .pokemonScale = 269,
        .pokemonOffset = 0,
        .trainerScale = 345,
        .trainerOffset = 7,
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .weight = 720,
        .description = COMPOUND_STRING(
        "Ein Larvitar wird tief unter der Erde geboren.\n"
        "Es muss sich durch den Boden darüber fressen und\n"
        "die Oberfläche erreichen, damit es die Gesichter seiner\n"
        "Eltern sehen kann."),
        .pokemonScale = 472,
        .pokemonOffset = 18,
        .trainerScale = 256,
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .weight = 1520,
        .description = COMPOUND_STRING(
        "Ein Pupitar erzeugt in seinem Körper ein\n"
        "Gas, das er unter Druck ausstößt, um sich\n"
        "wie ein Jet anzutreiben. Sein Körper hält einer\n"
        "Kollision mit massivem Stahl stand."),
        .pokemonScale = 292,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TYRANITAR] =
    {
        ...
        .weight = 2020,
        .description = COMPOUND_STRING(
        "Ein Tyranitar ist so überwältigend mächtig, dass er einen ganzen\n"
        "Berg niederreißen kann, um sein Nest zu bauen. Es\n"
        "streift durch die Berge und sucht nach neuen Gegnern,\n"
        "gegen die es kämpfen kann."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 345,
        .trainerOffset = 7,
    ...
    [SPECIES_TYRANITAR_MEGA] =
    {
        ...
        .weight = 2550,
        .description = COMPOUND_STRING(
        "Aufgrund der enormen Kraft, die in das Pokémon\n"
        "einströmte, platzte der Rücken dieses Pokémon völlig auf.\n"
        "Seine destruktiven Instinkte sind das Einzige, was ihn\n"
        "in Bewegung hält."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 345,
    ...
    [SPECIES_LUGIA] =
    {
        ...
        .categoryName = _("Tauchen"),
        .height = 52,
        .weight = 2160,
        .description = COMPOUND_STRING(
        "Lugia ist so mächtig, dass selbst\n"
        "ein leichter Flügelschlag Häuser in die Luft\n"
        "sprengen kann. Aus diesem Grund lebt es außer\n"
        "Sichtweite tief unter dem Meer."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 721,
        .trainerOffset = 19,
    ...
    [SPECIES_HO_OH] =
    {
        ...
        "leuchten, je nachdem, in welchem ​​Winkel sie\n"
        "vom Licht getroffen werden, sollen Freude bereiten.\n"
        "Es soll am Fuße eines Regenbogens leben."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 610,
        .trainerOffset = 17,
    ...
    [SPECIES_CELEBI] =
    {
        ...
        .weight = 50,
        .description = COMPOUND_STRING(
        "Dieses Pokémon kam durch eine Zeitkreuzung\n"
        "aus der Zukunft. Es wird angenommen,\n"
        "dass uns eine strahlende Zukunft\n"
        "erwartet, solange Celebi erscheint."),
        .pokemonScale = 393,
        .pokemonOffset = -10,
        .trainerScale = 256,
        .trainerOffset = 0,
