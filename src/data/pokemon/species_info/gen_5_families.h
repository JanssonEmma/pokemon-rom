...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_WHIMSICOTT] =
    {
        ...
        .categoryName = _("Windverschleiert"),
        .height = 7,
        .weight = 66,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_TIRTOUGA] =
    {
        ...
        .categoryName = _("Protoschildkröte"),
        .height = 7,
        .weight = 165,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_EMOLGA] =
    {
        ...
        .categoryName = _("Himmelseichhörnchen"),
        .height = 4,
        .weight = 50,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_CRYOGONAL] =
    {
        ...
        .categoryName = _("Kristallisieren"),
        .height = 11,
        .weight = 1480,
        .description = COMPOUND_STRING(
